...
class RoleSeeder extends Seeder
{
    ...
    {
        //Se debe importar el Models de Spatie
        ...
        /** @var  $permissions_admin = asignamos permisos de administrador*/
        ...
        /** @var  $permissions_editor = asignamos permisos de editores*/
        ...
        /** Sincronzamos permisos */
        $role_admin->syncPermissions($permissions_admin);
        $role_editor->syncPermissions($permissions_editor);

        //Para asignar un solo rol se hace con role_editor->givePermissionTo('nombre de permiso');
    }
}
